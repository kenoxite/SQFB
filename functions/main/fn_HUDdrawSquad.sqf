        ...
        if (!_unitOccluded) then {
            if (_alive || (!_alive && _SQFB_opt_showDead && (_unit getVariable "SQFB_veh") == _unit)) then {
                ...
                private _text = [
                                    [
                                        "",
                                        [_unit, _unitVisible, _SQFB_opt_showIndex, _SQFB_opt_AlwaysShowCritical, _SQFB_opt_showName, _SQFB_opt_showClass, _SQFB_opt_showRoles, _SQFB_opt_showDist, _SQFB_opt_outFOVindex, _SQFB_opt_profile, _SQFB_opt_preciseDist] call SQFB_fnc_HUDtext
                                    ] select (_SQFB_opt_showText && _textSize > 0.02 && (_isOnFoot || (!_isOnFoot && (_veh == _vehPlayer && cameraView == "INTERNAL")))),
                                    
                                    [
                                        "",
                                        [_veh, _unitVisible, _SQFB_opt_showIndex, _SQFB_opt_showClass, _SQFB_opt_showRoles, _SQFB_opt_ShowCrew, _SQFB_opt_showDist, _SQFB_opt_profile, _SQFB_opt_AlwaysShowCritical, _SQFB_opt_outFOVindex, _SQFB_opt_preciseDist] call SQFB_fnc_HUDtextVeh
